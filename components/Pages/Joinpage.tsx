			...
			<div className="bg-dark pt-16 pb-24 px-4 md:px-0">
				...
				<div className="container mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
					...
					<div className="bg-[#363b43] px-[35px] py-[40px] rounded-[7px]">
						...
						<p className="text-[16px] text-secondary mt-[30px] h-32">
							People do their best work when they’re happy and healthy, so we
							take care of our team members with full benefits, optional crypto
							payments, unlimited PTO, parental leave, and competitive
					...
					<div className="bg-[#363b43] px-[35px] py-[40px] rounded-[7px]">
						...
						<p className="text-[16px] text-secondary mt-[30px] h-32">
							We work remotely in the comfort of our own homes or offices with
							the benefit of a stroll in the park / on the beach sometimes too.
							Our remote-first policies give a true meaning to decentralization.
						</p>
					</div>
				</div>
			</div>
