			...
			<div className="bg-dark py-24 mt-40">
				<div className="flex flex-col space-y-16 md:space-y-0 md:flex-row max-w-[1300px] mx-auto items-center justify-between px-[24px] md:px-0">
					<div className="text-secondary">
						...
						<h2 className="text-[25px] md:text-[30px]">Mobile Wallet App</h2>
						<p className="mt-2 max-w-[470px] text-[13px] md:text-[16px]">
				...
				<div className="max-w-[1300px] mx-auto px-[22px] md:px-0">
					...
					<div className="grid grid-cols-1  w-full place-items-center md:grid-cols-3 gap-[35px] mt-[62px]">
						...
						<Card
							...
							tag="Product"
							title="Coinbase Launches 
“Learn-to-Earn” 
Campaign with Chain (XCN)"
							date="Thu Sep 22 2022"
							link="#"
						/>
						<Card
							...
							tag="Research"
							title="Chain Research – The 
Significance of ENS Domain 
Names and Their Use Cases"
							date="Thu Sep 22 2022"
							link="#"
						/>
					</div>
